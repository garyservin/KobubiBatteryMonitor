...
import static com.gservin.kobukibatterymonitor.BatteryMonitorWidgetProvider.EXT_UPDATE_WIDGETS;
...
public class BatteryMonitorService extends Service {
    ...
    private class BatteryStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            BatteryMonitorWidget.updateWidgets(context, mBatteryChargeLevel, mChargerConnected);
        }
    }
    ...
    public void onStart(Intent intent, int startId) {
        ...
        if (ext != null && ext.getBoolean(EXT_UPDATE_WIDGETS, false)) {
            BatteryMonitorWidget.updateWidgets(this, mBatteryChargeLevel, mChargerConnected);
        }
